...
public class DataUtils {
	...
	/**
	 * Retorna uma instáncia de <code>Date</code> refletindo os valores passados por parametro
	 * 
	 * @param dia
	 * @param mes
	 * @param ano
	 ...
	 * 	Esta comparaçãoo considera apenas dia, mes e ano
	 * 
	 * @param data1
	 * @param data2
	 * @return
